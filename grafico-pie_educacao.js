document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_educacao', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Educação',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Educação?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 419,color: '#198bfb' },
                { name: 'Bom', y: 1522, color: '#19fb8b' },
                { name: 'Regular', y: 322, color: '#e1fb19' },
