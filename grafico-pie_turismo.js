document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_turismo', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Turismo',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Turismo?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 323,color: '#198bfb' },
                { name: 'Bom', y: 1533, color: '#19fb8b' },
                { name: 'Regular', y: 385, color: '#e1fb19' },
                { name: 'Péssimo', y: 69, color: '#e11b19' },
