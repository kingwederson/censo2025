document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_obraseurbanismo', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Obras e Urbanismo',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Obras e Urbanismo?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 513,color: '#198bfb' },
                { name: 'Bom', y: 1470, color: '#19fb8b' },
                { name: 'Regular', y: 268, color: '#e1fb19' },
                { name: 'Péssimo', y: 59, color: '#e11b19' },
