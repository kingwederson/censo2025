document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_agropecuaria', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Agropecuária',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Agropecuária'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 291,color: '#198bfb' },
                { name: 'Bom', y: 1717, color: '#19fb8b' },
                { name: 'Regular', y: 259, color: '#e1fb19' },
                { name: 'Péssimo', y: 43, color: '#e11b19' },
