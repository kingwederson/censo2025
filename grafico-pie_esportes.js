document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_esportes', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Esportes',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Esportes?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 361,color: '#198bfb' },
                { name: 'Bom', y: 1597, color: '#19fb8b' },
                { name: 'Regular', y: 304, color: '#e1fb19' },
                { name: 'Péssimo', y: 48, color: '#e11b19' },
