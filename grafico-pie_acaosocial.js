document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_acaosocial', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Ação Social',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Ação Social?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 429,color: '#198bfb' },
                { name: 'Bom', y: 1632, color: '#19fb8b' },
                { name: 'Regular', y: 218, color: '#e1fb19' },
                { name: 'Péssimo', y: 31, color: '#e11b19' },
