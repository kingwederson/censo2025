document.addEventListener('DOMContentLoaded', function () {
    Highcharts.chart('grafico-pie_lazer', {
        chart: {
            type: 'pie',
            events: {
                render: function () {
        ...
        title: {
            text: 'Censo 2025: Avaliação da gestão na pasta de Lazer',
        },
        subtitle: {
            text: 'Como os representantes dos domicílios avaliam a gestão na pasta de Lazer?'
        },
        legend: {
            align: 'left',
        ...
        series: [{
            ...
            colorByPoint: true,
            data: [
                { name: 'Ótimo', y: 312,color: '#198bfb' },
                { name: 'Bom', y: 1440, color: '#19fb8b' },
                { name: 'Regular', y: 462, color: '#e1fb19' },
                { name: 'Péssimo', y: 96, color: '#e11b19' },
